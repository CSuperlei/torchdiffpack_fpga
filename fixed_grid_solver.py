'''
Author: CSuperlei
Date: 2022-01-29 11:51:30
LastEditTime: 2022-01-29 12:58:17
Description: 
'''
...
class RK4(FixedGridSolver):
    ...
    def step(self, func, t, dt, y, return_variables=False):
        ...
        out = tuple( _y + 1.0 / 6.0 * dt * _k1 + 1.0 / 3.0 * dt * _k2 + 1.0 / 3.0 * dt * _k3 + 1.0 / 6.0 * dt * _k4 for _y, _k1, _k2, _k3, _k4 in zip(y, k1, k2, k3, k4))
        if return_variables:
